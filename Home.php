...
<div class="art-header">
        <div class="art-header-position">
            <div class="art-header-wrapper">
                ...
                <div class="art-logo">
                                 <h1 class="art-logo-name"><a href="#">HOME</a></h1>
...
<br>
<br>
<a href="moviedisplay.php">
   <button>MOVIE DISPLAY</button>
</a>
<a href="dramadisplay.php">
   <button>EVENT DISPLAY</button>
</a>
<a href="showdisplay.php">
   <button>SHOWS DISPLAY</button>
</a>
<a href="ticketdisplay.php">
   <button>TICKETS DISPLAY</button>
</a>
